        ...
        <div class="bg-white/10 backdrop-blur-2xl border border-white/20 rounded-[2.5rem] shadow-2xl shadow-black/50 p-8 sm:p-10 relative overflow-hidden group">
            ...
            <form action="{{ route('login') }}" method="POST" class="space-y-6 relative z-10">
                ...
                <div class="relative flex items-center py-2">
                    ...
                    <span class="flex-shrink-0 mx-4 text-white/50 text-xs font-semibold uppercase tracking-wider">Atau</span>
                    <div class="flex-grow border-t border-white/20"></div>
                </div>

                <a href="{{ route('auth.google') }}" class="w-full bg-white/5 hover:bg-white/10 border border-white/10 text-white font-bold py-3.5 rounded-2xl flex items-center justify-center gap-3 transition-all duration-300 hover:scale-[1.02]">
